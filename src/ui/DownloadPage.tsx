...
const installCommand =
  'npm install -g https://axirune.velhu.com/downloads/axirune-language-0.5.0-alpha.1.tgz'
const vscodeCommand = 'code --install-extension axirune-0.5.0-alpha.1.vsix'
const dockerCommand = `mkdir axirune-0.5.0-alpha.1
tar -xzf axirune-source-0.5.0-alpha.1.tar.gz -C axirune-0.5.0-alpha.1
cd axirune-0.5.0-alpha.1
docker build -t axirune:0.5.0-alpha.1 .
docker run --rm -p 8080:8080 axirune:0.5.0-alpha.1`
    ...
    <>
      <section className="download-hero">
        <div className="download-hero__copy">
          <span className="eyebrow">
            <PackageOpen size={14} /> AXIRUNE 0.5.0-ALPHA.1 / ARCADE PREVIEW
          </span>
          ...
          <div className="download-hero__actions">
            <a className="button button--signal" href="/downloads/axirune-language-0.5.0-alpha.1.tgz" download>
      ...
      <section className="release-grid">
        <article className="release-card release-card--primary">
          ...
          <a href="/downloads/axirune-language-0.5.0-alpha.1.tgz" download>
            <FileArchive size={15} />
            axirune-language-0.5.0-alpha.1.tgz
        ...
        <article className="release-card">
          ...
          <a href="/downloads/axirune-0.5.0-alpha.1.vsix" download>
            <PlugZap size={15} />
            axirune-0.5.0-alpha.1.vsix
            <ArrowDownToLine size={15} />
          </a>
        </article>
        ...
        <article className="release-card">
          ...
          <a href="/downloads/axirune-source-0.5.0-alpha.1.tar.gz" download>
            <Container size={15} />
            axirune-source-0.5.0-alpha.1.tar.gz
            <ArrowDownToLine size={15} />
          </a>
        </article>
      </section>
      ...
      <section className="download-footnote section-shell">
        ...
        <p>
          {locale === 'zh'
            ? '0.5.0-alpha.1 发布 Arcade Collection：20 款原创可玩世界、8 类固定步进引擎、20 份真实 .axi 规则与零权限 .axc 胶囊，并提供逐款确定性基准。胶囊格式仍处于 Alpha；采用前请锁定版本、运行测试并审查请求权限。'
            : 'Axirune 0.5.0-alpha.1 ships Arcade Collection: 20 playable original worlds, eight fixed-step engine families, 20 real .axi rulesets with zero-authority .axc capsules, and per-world determinism benchmarks. The capsule format remains alpha; pin versions, run tests, and review requested authority before adoption.'}
        </p>
      </section>
    </>
  )
