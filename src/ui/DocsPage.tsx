    ...
    <>
      <section className="docs-hero">
        ...
        <div>
          ...
          <p>
            {locale === 'zh'
              ? 'Axirune 0.4 Alpha 通用核心、可验证执行胶囊、任务调用、递归、数据处理、错误、I/O 与可选 AI 的完整导览。'
              : 'A complete Axirune 0.4 Alpha tour: general-purpose core, verifiable execution capsules, task calls, recursion, data, errors, I/O, and optional AI.'}
        </p>
        </div>
      </section>
